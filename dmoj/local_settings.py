...
SECRET_KEY = 'keyboardcopycatthisissamplesecretkey'
...
DATABASES = {
     'default': {
        ...
        'NAME': '<MYSQL_DB_NAMEID>',
        'USER': '<MYSQL_USER_NAME>',
        'PASSWORD': '<MYSQL_USER_PASSWORD>',
         # 'HOST': 'reviewus.cmcerifw6mql.ap-northeast-2.rds.amazonaws.com',
        'HOST': '127.0.0.1',
        'OPTIONS': {
            'charset': 'utf8mb4',
...
SERVER_EMAIL = 'Admin <admin@example.com>'
...
TERMS_OF_SERVICE_URL = '//127.0.0.1/tos' # Use a flatpage.
...
PROBLEM_PDF_CACHE = '/home/user/pdfcache'
...
LOGGING = {
    ...
    'loggers': {
        ...
        # Ignore emailing by ALLOWED_HOSTS exception
...
SUMMERNOTE_CONFIG = {
    ...
    # Set limit on filesize for attachments
    'attachment_filesize_limit': 1024 * 1024 * 4, # 4MB
...
PROBLEM_DATA_ROOT = '/home/user/problems/'
